...
------------------------------------------------------------------------
  ...
  the dot1dTpFdbTable table.  The agent will start by looking for the right
  ...
  file defaults/table-dot1dTpFdbTable.m2d, and then re-running mib2c.
    ...
    in the dot1dTpFdbTable.h header.
    ...
    will be generated:
      ...
      dot1dTpFdbTable_allocate_data
      dot1dTpFdbTable_release_data
 ...
 Index(es) for the dot1dTpFdbTable table
  ------------------------------------------------------------
  The index(es) for the dot1dTpFdbTable table are:
...
************************************************************************
dot1dTpFdbTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the dot1dTpFdbTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: dot1dTpFdbTable_data_access.[c|h]
------------------------------------------------------------------------
  The dot1dTpFdbTable_data_access file contains the interface to your data in
  ...
  FUNC : dot1dTpFdbTable_indexes_set
  WHERE: dot1dTpFdbTable_data_access.c
...
File: dot1dTpFdbTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1dTpFdbPort_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dot1dTpFdbStatus_get



File: dot1dTpFdbTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the dot1dTpFdbTable table.

To watch the flow of the dot1dTpFdbTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        dot1dTpFdbTable
        verbose:dot1dTpFdbTable
        internal:dot1dTpFdbTable

e.g.
        snmpd -f -Le -Ddot1dTpFdbTable,verbose:dot1dTpFdbTable,internal:dot1dTpFdbTable
...
/*---------------------------------------------------------------------
 * BRIDGE-MIB::dot1dTpFdbEntry.dot1dTpFdbAddress
 * dot1dTpFdbAddress is subid 1 of dot1dTpFdbEntry.
